      ...
      <main className="pt-16 sm:pt-20 md:pt-24">
        ...
        <section className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 xl:px-16 2xl:px-24">
          <div className="max-w-4xl mx-auto">
            ...
            Step beyond the screen with our innovative AR/VR experiences. We bridge the gap between virtual and reality, creating memorable interactions that resonate.            </p>
          </div>
        </section>
        <ExpertiseSection />
        <MagicSection />
