      ...
      <main className="pt-16 sm:pt-20 md:pt-24">
        ...
        <section className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 xl:px-16 2xl:px-24">
          <div className="max-w-4xl mx-auto">
            ...
            Design meets function in our web creations. We build sites that not only look stunning but also connect with users and convert clicks into loyal customers.            </p>
          </div>
        </section>
        <ExpertiseSection />
        <MagicSection />
