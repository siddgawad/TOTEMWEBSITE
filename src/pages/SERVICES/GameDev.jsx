      ...
      <main className="pt-16 sm:pt-20 md:pt-24">
        ...
        <section className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 xl:px-16 2xl:px-24">
          <div className="max-w-4xl mx-auto">
            ...
            We craft immersive game experiences that go beyond the screen. From concept to code, our games are designed to captivate, challenge, and keep players coming back for more.            </p>
          </div>
        </section>
        <ExpertiseSection />
        <MagicSection />
