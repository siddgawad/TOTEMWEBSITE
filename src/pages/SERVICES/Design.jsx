      ...
      <main className="pt-16 sm:pt-20 md:pt-24">
        ...
        <section className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 xl:px-16 2xl:px-24">
          <div className="max-w-4xl mx-auto">
            ...
            Consult with us to unlock your brand’s potential. Our design strategies don’t just look good—they work hard, delivering impact and fostering growth.            </p>
          </div>
        </section>
        <ExpertiseSection />
        <MagicSection />
